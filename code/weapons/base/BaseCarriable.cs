...
namespace CitizenWarriorGame
{
	...
	public class BaseCarriable : AnimatedEntity
	{
		...
		public virtual void SimulateAnimator( CWAnimationHelper anim )
		{
			anim.HoldType = CWAnimationHelper.HoldTypes.Pistol;
			anim.Handedness = CWAnimationHelper.Hand.Both;
